...
import 'package:pak_lpg/Dashboard/Components/map_helper.dart';
import 'package:pak_lpg/Dashboard/Components/map_marker.dart';
      ...
      for(int i = 0; i<=location.response.length; i++) {
        ...
        setState(() {
          ...
          this._markerLocations =
              LatLng(double.parse(value[0]), double.parse(value[1]) ) as List<LatLng>;
